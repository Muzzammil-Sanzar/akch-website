...
export const PrevButton = (props) => {
  ...
  return (
    <button
      className="embla__button flex items-center justify-center rounded-full bg-orange-250 text-gray-150 w-7 md:w-10 h-7 md:h-10 embla__button--prev"
      type="button"
      {...restProps}
    >
...
export const NextButton = (props) => {
  ...
  return (
    <button
      className="embla__button flex items-center justify-center rounded-full bg-orange-250 text-gray-150 w-7 md:w-10 h-7 md:h-10 embla__button--next"
      type="button"
      {...restProps}
    >
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
