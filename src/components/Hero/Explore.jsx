      ...
      <div className="flex items-center justify-between">
        <div className="basis-3/5 space-y-10">
          <div className="space-y-2">
            <p className="salsa text-[32px]">Explore</p>
            <h1 className="text-orange-150 rammetto text-[52px]">“Traditional Taste of South India”</h1>
            <p className="text-lg text-gray-250 max-w-md">Lorem ipsum dolor sit amet consectetur. Sagittis quam cras eu velit ultrices </p>
          </div>
