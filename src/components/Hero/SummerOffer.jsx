              ...
              <div className="basis-1/3 space-y-1">
                ...
                <div className="space-y-6">
                  <div className="space-y-1">
                    <h2 className="rammetto text-4xl text-[#603B00]">Up to 30% OFF</h2>
                    <p className="text-lg text-gray-150">Order food and grocery delivery online from hundreds of restaurants and shops nearby.</p>
                  </div>
                  <div>
                    <button className="py-4 rounded-full bg-white text-gray-150 px-20 font-medium">Buy Now</button>
                  </div>
                </div>
              </div>
