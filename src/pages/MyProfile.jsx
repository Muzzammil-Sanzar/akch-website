  ...
  return (
    <div>
      <div className="space-y-10 ">
        <div className="bg-orange-250 p-4 sm:p-8 rounded-xl border ">
          <div className='flex flex-wrap gap-y-6 justify-between'>
            <div className='flex flex-wrap gap-y-4 items-center gap-8'>
              <img
        ...
        <div className="px-4 md:px-12 py-6 rounded-xl border space-y-4">
          <input
            type="text"
            value="Thaveeduraja"
