...
export default function ActiveOrder() {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-medium">My Active Order List</h2>
            ...
            <div className="flex flex-wrap lg:flex-nowrap gap-4 items-center justify-between bg-orange-250 px-5 py-6 shadow-sm rounded-xl">
              ...
              <div className="w-full flex flex-wrap md:flex-nowrap items-center justify-between gap-y-6">
                ...
                <div className="flex flex-col md:items-end">
                  <span className="text-[#07CD07] font-semibold text-xs mb-1">Deliver Today</span>
                  <span className="text-black font-semibold text-base">₹777.00</span>
                  <div className="mt-2 flex">
                    <button className="text-gray-150 px-6 py-2 bg-[#F1F1F1] rounded-full">
                      Edit
                    </button>
                    <button className="ml-2 text-[#FF0000] px-6 py-2 bg-[#F7DCDC] rounded-full">
                      Cancel
                    </button>
                  </div>
                </div>
